...
{    
    delta_w_ = planner_params["heuristic_reduction"];
}
...
void AgepasePlanner::expandEdge(EdgePtrType edge_ptr, int thread_id)
{
    ...
    // Pull the edge from map if it's already evaluated
...
void AgepasePlanner::updateEdge(EdgePtrType edge_ptr, StatePtrType successor_state_ptr, double new_g_val)
{
