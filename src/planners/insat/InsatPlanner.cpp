...
InsatstarPlanner::InsatstarPlanner(ParamsType planner_params):
        Planner(planner_params)
{

}

InsatstarPlanner::~InsatstarPlanner()
{

}

bool InsatstarPlanner::Plan()
{
    initialize();
...
void InsatstarPlanner::initialize()
{
    Planner::initialize();
...
void InsatstarPlanner::expandState(StatePtrType state_ptr)
{
...
void InsatstarPlanner::updateState(StatePtrType& state_ptr, ActionPtrType& action_ptr, ActionSuccessor& action_successor)
{
