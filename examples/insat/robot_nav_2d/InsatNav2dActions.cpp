...
namespace ps
{
                                                            ...
                                                            opt_(opt)
   {
    ...
    bool InsatNav2dAction::CheckPreconditions(const StateVarsType& state)
    {
        return true;
    }

    ActionSuccessor InsatNav2dAction::GetSuccessor(const StateVarsType& state_vars, int thread_id)
    {
    ...
    ActionSuccessor InsatNav2dAction::GetSuccessorLazy(const StateVarsType& state_vars, int thread_id)
    {
    ...
    ActionSuccessor InsatNav2dAction::Evaluate(const StateVarsType& parent_state_vars, const StateVarsType& child_state_vars, int thread_id)
    {
